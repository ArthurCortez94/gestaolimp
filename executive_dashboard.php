 ...
 * Versão: 2.0 - Interface Moderna e Profissional
 */
...
try {
    ...
    $alertas = $dashboard->getAlertas();
    $estatisticas = $dashboard->getEstatisticasGerais();
} catch (Exception $e) {
    ...
    $agendamentos = ['total_agendamentos' => 0, 'em_andamento' => 0];
    $funcionarios = ['funcionarios_ativos' => 0, 'total_funcionarios' => 0, 'em_trabalho' => 0];
    $lavanderia = ['total_itens' => 0, 'prontos' => 0];
    $proximosServicos = [];
    $entregasTapetes = [];
    ...
    $alertas = [];
    $estatisticas = ['total_clientes' => 0, 'servicos_mes' => 0, 'ticket_medio' => 245];
}
?>
<!DOCTYPE html>
<html lang="pt-br">
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="content-grid">
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-content">
                                        <div class="service-info">
                                            <h4><?php echo sanitizar($servico['cliente']); ?></h4>
                                            <div class="service-details">
                                                <i class="fas fa-map-marker-alt"></i>
                                                <?php echo sanitizar($servico['tipo_servico'] ?? 'Limpeza Residencial'); ?>
                                            </div>
                                        </div>
                                        <span class="status-badge <?php echo getStatusClass($servico['status']); ?>">
                                            <?php echo formatarStatus($servico['status']); ?>
                                        </span>
                                    </div>
                                </div>
                            <?php endforeach; ?>
            ...
            <!-- Sidebar com Entregas e Performance -->
                                ...
                                <?php foreach (array_slice($entregasTapetes, 0, 4) as $tapete): ?>
                                    <div class="delivery-item">
                                        ...
                                        <div class="delivery-info">
                                            <div class="delivery-client"><?php echo sanitizar($tapete['cliente']); ?></div>
                ...
                <div class="card-content">
                    ...
                    <div class="chart-stats">
                        ...
                        for ($i = 0; $i < count($distribuicao['labels']); $i++): 
                            $percentage = count($distribuicao['valores']) > 0 ? 
                                round(($distribuicao['valores'][$i] / array_sum($distribuicao['valores'])) * 100) : 0;
                        ?>
                            <div class="stat-legend">
                                <div class="legend-dot" style="background: <?php echo $colors[$i % count($colors)]; ?>;"></div>
                                <div class="legend-text"><?php echo $distribuicao['labels'][$i]; ?> (<?php echo $percentage; ?>%)</div>
                            </div>
                        <?php endfor; ?>
                    </div>
                </div>
                ...
                <div class="card-content">
                    <div class="performance-metrics">
                        ...
                        <div class="metric-item">
                            ...
                            <div class="metric-value-large"><?php echo formatarMoeda($estatisticas['ticket_medio']); ?></div>
                        </div>
                        <div class="metric-item">
                            <div class="metric-info">
                                <h4>ROI Marketing</h4>
                ...
                <?php foreach ($alertas as $alerta): ?>
                    <div class="alert-card <?php echo $alerta['tipo']; ?>">
                        <div class="alert-header">
                            ...
                            <div class="alert-title"><?php echo sanitizar($alerta['titulo']); ?></div>
                        </div>
                        <div class="alert-message">
                            <?php echo sanitizar($alerta['mensagem']); ?>
                        </div>
                        <div class="alert-actions">
                            <?php foreach ($alerta['acoes'] as $index => $acao): ?>
                                <button class="alert-btn <?php echo $index > 0 ? 'secondary' : ''; ?>">
                                    <?php echo sanitizar($acao); ?>
                                </button>
                            <?php endforeach; ?>
                        </div>
                    </div>
